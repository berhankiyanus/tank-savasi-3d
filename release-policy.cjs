...
const shell=['index.html','main.js','game-progress.mjs','garage-content.mjs','garage-visuals.mjs','polish.css','manifest.json','sw.js','CREDITS.md','privacy.html','licenses.html'];
